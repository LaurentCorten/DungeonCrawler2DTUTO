...
//     version 1.17.0
//     from Assets/InputPlayerMouvement.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/InputPlayerMouvement.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @InputPlayerMouvement: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @InputPlayerMouvement()
    {
        asset = InputActionAsset.FromJson(@"{
    ""version"": 1,
    ""name"": ""InputPlayerMouvement"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    ~@InputPlayerMouvement()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, InputPlayerMouvement.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, InputPlayerMouvement.UI.Disable() has not been called.");
    }
    ...
    {
        private @InputPlayerMouvement m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PlayerActions(@InputPlayerMouvement wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@InputPlayerMouvement wrapper) { m_Wrapper = wrapper; }
        /// <summary>
